...
app.get('/api/location-events/:location/:when', (request, response) => {
  const eventBotLocation = new EventLocation();
  eventBotLocation.getEventsByLocation(request.params.location, request.params.when).then((eventDataLocation) => {
